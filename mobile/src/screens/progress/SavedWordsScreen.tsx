...
export function SavedWordsScreen() {
  ...
  if (!savedWords.data?.length) {
    return <EmptyState title="No saved words yet" message="Save words from word detail to build a review list." actionLabel="Scan Tile" onAction={() => navigation.navigate("ScannerTab")} />;
  }
